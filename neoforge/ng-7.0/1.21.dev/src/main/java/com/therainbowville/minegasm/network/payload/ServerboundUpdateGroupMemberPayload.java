...
public record ServerboundUpdateGroupMemberPayload(UUID groupUUID, MinegasmGroupMember updated) implements CustomPacketPayload {
    ...
    public static final StreamCodec<FriendlyByteBuf, ServerboundUpdateGroupMemberPayload> STREAM_CODEC = StreamCodec.composite(
        UUIDUtil.STREAM_CODEC, ServerboundUpdateGroupMemberPayload::groupUUID,
